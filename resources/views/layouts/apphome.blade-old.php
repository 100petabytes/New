                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            ...
                            <div class="row Analytics_box">
                                <h4>Timmy Time Completed</h4>
                                <ul>
                                    <li>
                                        <label>Last 24 Hrs</label>
                                        <span class="time" id="in-24hrs">0 min</span>
                                    </li>
                                    <li>
                                        <label>Last Week</label>
                                        <span class="time" id="in-7days">0 min</span>
                                    </li>
                                    <li>
                                        <label>Last 30 Days</label>
                                        <span class="time" id="in-30days">6 hr 36 min</span>
                                    </li>
                                    <li>
                                        <label>All Time</label>
                                        <span class="time" id="in-total">6 hr 36 min</span>
                                    </li>
                                </ul>
                            </div>
